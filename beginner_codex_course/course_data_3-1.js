...
========================================================================
2026-06-03 V8.00-L31: 👑 LEVEL 3 首發單元 3-1 核心大腦完璧版。
1. 骨架合流：100% 複製 1-1 雙層原位切換架構，採用 window.codexCourseEngineData 拓撲。
2. 視覺對位：Page 1 常駐 3-1 全景圖資產；Page 2 與 Page 3 Keywords 卡牌全面剛性對齊 repeat(4, 1fr) 拓撲。
3. 重工業教材：滿血灌注「SYSTEM TPM 天職」四大象限與「TechOps Playbook」實戰除錯劇本。
4. 題庫裝甲：內建 12 道高頻硬核考核題庫（各領域 4 題），附帶雙層動態隨機洗牌選項引擎，尾端 100% 閉合。
========================================================================
*/
...
window.codexCourseEngineData = [
    {
        ...
        subPages: [
            // ==========================================
            // PAGE 1: 獨立全景導航地圖 (對齊 1-1 page 1 規格)
            // ==========================================
            {
            ...
            // ==========================================
            // PAGE 2: SYSTEM TPM 天職 (Scope: duty)
            // ==========================================
            {
                ...
                text: `
                    ...
                    <div id="tpm-main-panel-duty-2" style="display:none; width:100%;">
                        <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:12px;">
                            ...
                            <div style="background:#FFF; border:2px solid #1A1A1A; border-radius:6px; padding:12px; box-shadow:2px 2px 0px #1A1A1A;"><div style="font-size:0.75rem; font-weight:900; color:#475569; border-bottom:1px dashed #1A1A1A; padding-bottom:4px; margin-bottom:6px;">👁️ 3. 期望結果</div><div style="font-size:0.82rem; font-weight:700; line-height:1.4; color:#1A1A1A;">專案隨時維持 Second Source 熱備援狀態，物料一次直通，開線現場 100% 無料料偏位風險。</div></div>
                        </div>
                    </div>
            ...
            // ==========================================
            // PAGE 3: TechOps Playbook (Scope: playbook)
            // ==========================================
            {
                ...
                text: `
                    ...
                    <div id="tpm-main-panel-playbook-0" style="display:block; width:100%;">
                        <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:12px;">
                            ...
                            <div style="background:#FFF; border:2px solid #1A1A1A; border-radius:6px; padding:12px; box-shadow:2px 2px 0px #1A1A1A;"><div style="font-size:0.75rem; font-weight:900; color:#475569; border-bottom:1px dashed #1A1A1A; padding-bottom:4px; margin-bottom:6px;">🎯 2. 目的</div><div style="font-size:0.82rem; font-weight:700; line-height:1.4; color:#1A1A1A;">掐死空銲短路。將機台誤判率（False Alarm）壓制在 1% 以下，防止重工室暴走摧毀 PCB 銅箔。</div></div>
                        ...
                        <div style="margin-top:15px; border:2px solid #1A1A1A; border-radius:8px; padding:16px; background:#FFF; box-shadow:4px 4px 0px #1A1A1A;">
                            ...
                            <div style="display:grid; grid-template-columns:repeat(4, 1fr); gap:10px; margin-bottom:12px;">
                                ...
                                <div class="kbtn-playbook-0" id="kbtn-playbook-0-3" style="background:#FFFFFF; border:2px solid #1A1A1A; border-radius:6px; padding:10px; text-align:center; font-weight:900; font-size:0.82rem; cursor:pointer; box-shadow:2px 2px 0px #1A1A1A;" onclick="window.tpmSwitchSubKwd('playbook', 0, 3, 'Component Component Scrap (高頻吸嘴拋料報廢損耗)', '貼片機吸嘴真空度不足或供料器震動，導致晶片被生生拋入廢料盒。拋料率超過 0.3% 必須剛性停線。')">Comp Scrap</div>
                            </div>
        ...
        // ==========================================
        // EXAM VAULT MATRIX: 12 道高頻硬核大考大盤
        // ==========================================
        examVault: [
            // [領域 A: SYSTEM TPM 天職 - 4題]
            ...
            // [領域 C: 綜合要素與財務防線 - 4題]
            { q: "在 4M1E 要素控管中，針對容易吸附空氣水分、一旦拆封受潮過爐會引發微觀爆米花銲裂的晶片元件，稱為？", o: ["MSD 溫濕度敏感元件", "FIFO 先進料件", "AVL 准入組件"], a: 0 },
            { q: "組裝流水線開線前，為了消除最慢瓶頸工位、確保人工手速秒數恆定以拉升 UPH，IE 製造部必須核檢？
", o: ["Line Balancing 大流水線工位平衡率", "OQC 出廠憑證", "ORT 持續信賴性"], a: 0 },
