...
========================================================================
2026-05-29 V5.13: 👑 window 中樞修正版：更正最新時間。全量多行展開。將頭部宣告與尾部 IIFE 洗牌引擎內的變數讀取全部剛性綁定至 window.codexCourseEngineData 中樞，徹底消滅線上跨檔案環境下的 ReferenceError 與 SyntaxError。Section 1~3 教材與 30題完全體交付，禁止任何省略。
========================================================================
*/
...
window.codexCourseEngineData = [
    {
                        ...
                        text: `
                            <div class="edu-overview-container">
                                <div class="edu-overview-card">
                                    ...
                                    <div class="edu-card-body-text">主導全球市場調研、產品外觀工業設計（ID）與微觀內部結構設計（ME）。撰寫初代產品規格需求書（PRD），並對外發佈交付神聖的 2D/3D 工程開發圖紙（2D Drawing）。</div>
                                </div>
                                <div class="edu-overview-card">
                                    <div class="edu-card-label">🎯 核心戰術目標</div>
                                    <div class="edu-card-body-text">追求無懈可擊的微觀美學突破、極致技術參數（如超薄型、特殊外殼視覺），用極高難度的工藝拉高市場定價、溢價與品牌防線。</div>
                                </div>
                                <div class="edu-overview-card">
                                    <div class="edu-card-label">👁️ 團隊終極期待</div>
                                    <div class="edu-card-body-text">期待代工製造廠（EMS）能夠 100% 完美復刻所有複雜結構，不允許工廠以 any 設備組裝公差疊加溢出為藉口而輕易輕易輕易去修改原廠外觀。</div>
                                </div>
                            </div>
                            <div class="sandbox-panel-card">
                                <div class="edu-card-label">📖 戰術檢查字典（點擊術語解鎖避坑細節）</div>
                                <div class="dict-btn-grid">
                                    <button class="dict-trigger-btn" onclick="showTacticalDict('【PRD 規格防線審查】：必須全面清查 CMF（色彩、材質、工藝）是否具備工廠現有流水線的量產製程能力，在開模前剛性攔截不切實際的幻想規格。')"><span>🔍 PRD 規格審查</span><span>➔</span></button>
                                    <button class="dict-trigger-btn" onclick="showTacticalDict('【公差疊加分析】：在圖紙出爐第一時間，ME團隊必須發動極限疊加模擬，計算零件間的微米級物理干涉，提前鎖死模具與變形雷區。')"><span>🔍 公差疊加分析</span><span>➔</span></button>
                                </div>
                                <div id="runtime-dict-box" class="dict-display-box"></div>
                            </div>
                            <div class="sandbox-panel-card">
                                <div class="edu-card-label">🎮 TPM 工程決策決斷沙盒（學以致用模擬演練）</div>
                                <div style="font-size:0.95rem; font-weight:700; line-height:1.5; margin-bottom:10px;">🚨 <strong>現場突發修羅場：</strong>客戶 R&D 為了美感，強行要求將內部主板與外殼的 Clearance 安全防護間距由標準 0.3mm 壓縮至極限 0.1mm，你身為代工廠 TPM，此時的第一決斷是？</div>
                                <div class="sandbox-choice-row">
                                    <button class="sandbox-choice-btn" onclick="triggerSimDecision(false, '💥 <strong>模擬命運：專案全盤停線崩潰！</strong><br>你選擇直接簽字放行滿足客戶。結果在 PVT 試產拉速時，因零件設備微小公差疊加，主板當場被殼體物理擠壓變形、電路短路集體燒毀，良率直接歸零！模具當場報廢，專案被迫延期兩個月！')">方案 A：聽從客戶意見直接簽字放行，滿足美學堅持。</button>
                                    <button class="sandbox-choice-btn" onclick="triggerSimDecision(true, '🏆 <strong>模擬命運：技術拆彈成功，名望大增！</strong><br>你拒絕盲從，啟動跨功能 Trade-off 決策矩陣。帶領 ME 與 EE 調閱數據，向客戶實證 0.1mm 會引發短路海嘯。最終成功說服客戶微調內部隱蔽骨架，既保住 0.3mm 安全防護間距，又完美維持外部美學，如期 Exit 出關！')">方案 B：啟動跨功能技術仲裁，出示公差公理實證，逼出技術妥協點。</button>
                                </div>
                        ...
                        text: `
                            <div class="edu-overview-container">
                                <div class="edu-overview-card">
                                    ...
                                    <div class="edu-card-body-text">研發與控制特定元件的晶圓材料技術（如晶片晶圓廠、相機鏡頭模組廠、射頻感測器廠）。負責向代工廠提供初期驗證樣品（Samples），並在大量生產（MP）時向代工廠輸送零件原料。</div>
                                </div>
                                <div class="edu-overview-card">
                                    <div class="edu-card-label">🎯 核心戰術目標</div>
                                    <div class="edu-card-body-text">在晶圓與特種材料技術防線上維持行業領先。穩定控制零件出廠良率，並確保在專案跨入大量生產時的原料供給產能無虞。</div>
                                </div>
                                <div class="edu-overview-card">
                                    <div class="edu-card-label">👁️ 團隊終極期待</div>
                                    <div class="edu-card-body-text">期待代工廠提供精確無偏位的料期預測（Forecast），並在工廠進行進料檢驗（IQC）與工位拼裝時，不因工藝不當或靜電損壞其原件。</div>
                                </div>
                            </div>
                            <div class="sandbox-panel-card">
                                <div class="edu-card-label">📖 戰術檢查字典（點擊術語解鎖避坑細節）</div>
                                <div class="dict-btn-grid">
                                    <button class="dict-trigger-btn" onclick="showTacticalDict('【長料期沙漏控管】：精確追蹤 Lead Time 超過 12 週的稀缺晶片。建立物料沙漏水位，一旦長料期發生供應斷線，必須立即發動二線備料（Dual Source）認證防線。')"><span>🔍 長料期沙漏控管</span><span>➔</span></button>
                            ...
                            <div class="sandbox-panel-card">
                                ...
                                <div class="sandbox-choice-row">
                                    <button class="sandbox-choice-btn" onclick="triggerSimDecision(false, '💥 <strong>模擬命運：產線開空窗，工廠開罰！</strong><br>你選擇在辦公室等待日本原廠重調配方。結果線體被迫停工待料 5 天，數百名操作工閒置，產線進度嚴重偏離，遭到主管與客戶集體彈劾！')">方案 A：發出警告郵件，並在線體上死等日本原廠配方重調完畢。</button>
                                    <button class="sandbox-choice-btn" onclick="triggerSimDecision(true, '🏆 <strong>模擬命運：完美備援，如期開線！</strong><br>你果斷發起跨部門應變，清查 Common Pool 資源，調用國內二線備料供應商的儲備樣品，帶領團隊進行 12 小時極速信賴性點亮驗證，成功頂替缺料，流水線一氣盒成順利過關！')">方案 B：啟動二線供應商（Dual Source）應變防線，調用樣品進行極速可靠性點亮複審。</button>
                                </div>
                                <div id="runtime-sandbox-fallout" class="sandbox-fallout-box"></div>
                            </div>
                        `
                        ...
                        text: `
                            <div class="edu-overview-container">
                                <div class="edu-overview-card">
                                    ...
                                    <div class="edu-card-body-text">我們的絕對基地（Foxconn / FIH）。接過客戶 2D/3D 圖紙指令，吞下供應商輸送過來的物料。在設備公差疊加與拉速上限邊界下，進行硬體實體化的大規模複製組裝。</div>
                                </div>
                                <div class="edu-overview-card">
                                    <div class="edu-card-label">🎯 核心戰術目標</div>
                                    <div class="edu-card-body-text">死守直通率（FPY），消滅製程瓶頸。在 PVT 與 MP 階段極速提升每小時產能速率（UPH），以極低的不良率完成大批量複製，死守代工毛利。</div>
                                </div>
                                <div class="edu-overview-card">
                                    <div class="edu-card-label">👁️ 團隊終極期待</div>
                                    <div class="edu-card-body-text">期待 TPM 扮演跨功能（XFN）大腦，在試產缺陷、線體治具卡死或動態設計變更（ECO）爆發時，第一時間找出不良根本原因（Root Cause），主導技術拆彈。</div>
                                </div>
                            </div>
                            <div class="sandbox-panel-card">
                                <div class="edu-card-label">📖 戰術檢查字典（點擊術語解鎖避坑細節）</div>
                                <div class="dict-btn-grid">
                                    <button class="dict-trigger-btn" onclick="showTacticalDict('【線平衡率 Line Balance】：評估整條大流水線各個工位工時的平均配比度。線平衡率低於 85% 代表存在嚴重瓶頸工位，會引發產線集體堆料、拉速垮台。')"><span>🔍 線平衡率平衡指標</span><span>➔</span></button>
                            ...
                            <div class="sandbox-panel-card">
                                ...
                                <div class="sandbox-choice-row">
                                    <button class="sandbox-choice-btn" onclick="triggerSimDecision(false, '💥 <strong>模擬命運：客退海嘯，專案判死！</strong><br>你看到 98.5% 良率就放行出關。結果產品流入實體市場後，因為大批經歷過手工二次高溫重工修補的手機內傷爆發，開箱即損（DOA）故障率集體炸裂！客戶發動全面退貨清算，代工廠毛利當場歸零！')">方案 A：良率既然過關，配合工廠主管如期開閘，准許出關大量生產（MP）。</button>
                                    <button class="sandbox-choice-btn" onclick="triggerSimDecision(true, '🏆 <strong>模擬命運：鐵血攔截，斬斷隱形內傷！</strong><br>你死守剛性鐵律：『不斬良率，只斬直通率！』當場鐵血攔截專案、拒絕出關。勒令製程 ME 團隊徹查線體，抓出鋼網磨損與治具公差偏移，將 FPY拉回 85% 以上才准予放行，徹底消滅客退海嘯！')">方案 B：一票否決、強行攔截！下令產線停線重調治具，將直通率拉回剛性指標。</button>
                                </div>
                                <div id="runtime-sandbox-fallout" class="sandbox-fallout-box"></div>
                            </div>
                        `
                                ...
                                text: `
                                    ...
                                    <div class="sandbox-panel-card">
                                        ...
                                        <div class="sandbox-choice-row">
                                            ...
                                            <button class="sandbox-choice-btn" onclick="triggerSimDecision(true, '🏆 <strong>模擬命運：首爐點亮大獲全勝！</strong><br>你果斷按下攔截鈕，發起跨功能對決，強迫 ME 與 EE 將主板Layout挪移拉伸，剛性拉出 0.3mm 的安全間距，徹底封鎖了後續開爐貼片的變形雷區！')">方案 B：鐵血攔截！要求團隊重新優化 Layout，剛性拉出安全間距防線。</button>
                                        </div>
                                        <div id="runtime-sandbox-fallout" class="sandbox-fallout-box"></div>
                                    </div>
                                ` 
                            ...
                            { 
                                ...
                                text: `
                                    ...
                                    <div class="sandbox-panel-card">
                                        <div class="edu-card-label">📖 戰術檢查字典（點擊術語解鎖避坑細節）</div>
                                        <div class="dict-btn-grid">
                                            <button class="dict-trigger-btn" onclick="showTacticalDict('【Power-on 點亮流程】：硬體試產最神盛的一動。通電量測主電壓軌（Power Rails）有無對地短路，嚴防一插電瞬間燒毀大腦主晶片。')"><span>🔍 首版通電點亮</span><span>➔</span></button>
                                    ...
                                    <div class="sandbox-panel-card">
                                        ...
                                        <div class="sandbox-choice-row">
                                            ...
                                            <button class="sandbox-choice-btn" onclick="triggerSimDecision(true, '🏆 <strong>模擬命運：鐵證如山，1小時一錘定音！</strong><br>你果斷發起現場 X-Ray 與 Cross-section 切片屍檢！1小時內抓到是工廠熔爐後鋼網磨損導致錫膏溢出短路。工廠當場認賠重新開爐趕工，保住試產時程！')">方案 B：親自帶隊發動現場 X-Ray 與解剖分析（Cross-section），拿實證切片說話。</button>
                                        </div>
                                        <div id="runtime-sandbox-fallout" class="sandbox-fallout-box"></div>
                                    </div>
                                ` 
                            ...
                            { 
                                ...
                                text: `
                                    <div class="edu-overview-container">
                                        ...
                                        <div class="edu-overview-card">
                                            <div class="edu-card-label">🎯 核心戰術目標</div>
                                            <div class="edu-card-body-text">全面考核工廠流水線的大規模複製組裝能力（UPH）。調校每道操作工位的作業工時，進行開線生產拉速與線平衡總驗收。</div>
                                        </div>
                                        <div class="edu-overview-card">
                                            <div class="edu-card-label">👁️ 團隊終極期待</div>
                                            <div class="edu-card-body-text">剛性驗證自動化測試治具（ICT/FCT）的防錯能力與工廠製程能力指數（Cpk），確保複製出來的一萬台設備毫無失真。</div>
                                        </div>
                                    </div>
                                    <div class="sandbox-panel-card">
                                        <div class="edu-card-label">📖 戰術檢查字典（點擊術語解鎖避坑細節）</div>
                                    ...
                                    <div class="sandbox-panel-card">
                                        ...
                                        <div class="sandbox-choice-row">
                                            <button class="sandbox-choice-btn" onclick="triggerSimDecision(false, '💥 <strong>模擬命運：漏檢大爆發，工廠面臨巨額索賠！</strong><br>你催促工人加快手腳。結果大批嚴重刮傷缺陷機流入包裝 Packing 站，客檢當場判定集體退貨，工廠開線成本開出大空窗！')">方案 A：口頭催促品檢員加快人工掃描手腳，避免堆料。</button>
                            ...
                            { 
                                ...
                                text: `
                                    <div class="edu-overview-container">
                                        ...
                                        <div class="edu-overview-card">
                                            <div class="edu-card-label">👁️ 團隊終極期待</div>
                                            <div class="edu-card-body-text">新產品導入（NPI）功德圓滿。TPM 必須將本次戰役的所有缺陷、開線死鎖、模具血淚教訓凝結成文件，傳送回大圖書館大庫。</div>
                                        </div>
                                    </div>
                                    <div class="sandbox-panel-card">
                                        <div class="edu-card-label">📖 戰術檢查字典（點擊術語解鎖避坑細節）</div>
                                        <div class="dict-btn-grid">
                                            <button class="dict-trigger-btn" onclick="showTacticalDict('【出關基準 Exit Criteria】：進入 MP 前必須跨過的剛性門檻。包含 FPY 達標、Cpk > 1.33、法規 Compliance 認證完全解鎖。')"><span>🔍 量產出關剛性指標</span><span>➔</span></button>
                                    ...
                                    <div class="sandbox-panel-card">
                                        <div class="edu-card-label">🎮 TPM 工程決策決斷沙盒（學以致用模擬演練）</div>
                                        <div style="font-size:0.95rem; font-weight:700; line-height:1.5; margin-bottom:10px;">🚨 <strong>現場突發修羅場：</strong>MP 大批量出貨一週後，實體市場傳來嚴重回報，特定批次鋰電池因日常充放電發生物理膨脹引發起火客退，此時你的第一移動是？</div>
                                        <div class="sandbox-choice-row">
                        ...
                        diagramFlowArray: [
                            { 
                                ...
                                text: `
                                    ...
                                    <div class="sandbox-panel-card">
                                        <div class="edu-card-label">🎮 TPM 工程決策決斷沙盒（學以致用模擬演練）</div>
                                        <div style="font-size:0.95rem; font-weight:700; line-height:1.5; margin-bottom:10px;">🚨 <strong>產線突發修羅場：</strong>SMT 過完爐後，AOI 光學天眼集體回報晶片引腳爆發大面積虛焊（Solder Skip），工廠主管堅持是 EE 板材散熱過快，要求停線修改 Layout，意下如何？</div>
                                        <div class="sandbox-choice-row">
                                            <button class="sandbox-choice-btn" onclick="triggerSimDecision(false, '💥 <strong>模擬命運：研發周期失鎖，專案判死！</strong><br>你盲目聽信改圖。結果重過 Layout 耗費兩週，工廠大模具晾在現場，生產排程全盤垮台，被客戶當場編錄發配邊疆！')">方案 A：相信工廠，開單攔截專案並退回給 EE 重新修改 Layout 圖紙。</button>
                                ...
                                text: `
                                    ...
                                    <div class="sandbox-panel-card">
                                        ...
                                        <div class="sandbox-choice-row">
                                            ...
                                            <button class="sandbox-choice-btn" onclick="triggerSimDecision(true, '🏆 <strong>模擬命運：Poka-Yoke 零成本完美拆彈！</strong><br>你現場觀戰！發現是工人用大拇指指甲硬塞。你當場在線體加裝一組塑料防錯導向治具（Poka-Yoke），不花一毛改模費，良率原地滿血復活！')">方案 B：下線現場解剖手法！清查操作工是否遵循 SOP，並評估加裝防錯導向治具。 </button>
                                        </div>
                                        <div id="runtime-sandbox-fallout" class="sandbox-fallout-box"></div>
                                    </div>
                                ` 
        ...
        examVault: [
            { q: "當零件廠商（Vendor）通知核心晶片的料期（Lead Time）因上游晶圓廠產能吃緊，從 8 週暴增至 24 週，直接撞上專案 PVT 時程，身為 EMS 廠的 TPM 最佳拆彈路徑是？", o: ["要求工廠全面停線，發信指責供應商並死等對方產能恢復", "要求客戶修改產品規格書（PRD），調降晶片效能以改用現貨舊晶片", "立即清查 Common Pool 呆料資源，調研相容晶片引腳（Pin-to-Pin）代償可行性，並發動備援二線（Dual Source）極速可靠性認證防線"], a: 2 },
            { q: "工廠匯報 FATP 結案數據：入庫良率高達 99.2%，但流水線直通率（FPY）只有 28%。此時 TPM 應做出何種技術決斷？", o: ["良率極高，代表製程完美受控，可以開閘直接宣佈進入大量量產（MP）", "一票否決！高度懷疑過半機器在線體被手工反覆拆解重工（Rework），帶有物理內傷，極易引發 DOA，應勒令停線徹查治具與公差缺陷", "認定工廠員工偷懶，要求產線主管對操作工進行懲罰性扣薪"], a: 1 },
            { q: "在高階手機專案進入 EVT 里程碑末期，ME 團隊準備開啟外殼硬模（Hard Tooling）前，TPM 必須剛性要求團隊交付哪一項工程實證報告以防止開模失敗引發百萬巨損？", o: ["客戶的 CMF 貼圖與表面美學樣板說明", "100% 滿載的極慢公差疊加分析（Tolerance Stack Analysis）與 DFM 可製造性最終審查", "工廠目前的每小時產速（UPH）預估報告"], a: 1 },
            { q: "在 DVT 階段進行整機氣密測試（Leak Test）時，發現金屬框與玻璃接縫處集體爆發漏氣，工廠工程師宣稱是防水膠固化劑調配不均，TPM 該如何利用數據主導技術拆彈？", o: ["全盤聽從工廠說法，要求日本膠水原廠直接退款補償", "發起鎖附扭力對比、外殼微觀間隙量測與膠路寬度微調的 DOE 實驗驗證，以數據斷定是結構應力干涉還是材料失效", "直接向客戶提議將防水規格從 IPX8 降為 IPX4 以順利出關"], a: 1 },
            { q: "客戶 ID 設計師為了產品極致美感，在 3D 藍圖上堅持做出『0 拔模角』的銳利邊緣外殼。工廠警告量產頂出會發生裝修收縮痕（Sink Marks），TPM 應如何從跨功能（XFN）視角進行技術仲裁？", o: ["全盤聽從 ID，要求工廠工程師不惜代價強行開模，良率虧損由製造廠自行吞下", "在不觸動客戶正面外觀的前提下，主導 ME 微調內部隱蔽骨架肉厚，並協調工廠在噴砂工藝上優化，利用光線漫反射遮蓋痕跡", "強行發起投票取消該專案，避免後續虧損"], a: 1 },
            { q: "主機板過完 SMT 迴流焊熔爐（Reflow Oven）後，AOI 光學天眼集體回報晶片焊盤爆發大量錫橋短路（Bridging）。TPM 應帶領團隊優先溯源檢查哪一個工位的數據與治具？", o: ["後段 FATP 的人工組裝扣合工位", "前段 SMT 的印刷錫膏印刷站（SPI）厚度數據與鋼網（Stencil）磨損狀況", "包裝 Packing 站的整箱秤重感測器設定"], a: 1 },
            { q: "在 PVT 試產階段，產線主管抱怨 FCT 功能測試工位的 Cycle Time（操作時間）過長，導致整條流水線出現嚴重的堆料（WIP）。這項缺陷會直接摧毀工廠的哪一項核心指標？", o: ["客戶研發端的 BOM Cost 成本範疇", "流水線的線平衡率（Line Balance）與整線每小時產能產速（UPH）", "產品的信賴性可靠性生命週期"], a: 1 },
            { q: "天線射頻工程師要求追加 0.5mm 的安全 Clearance 間距，結構 ME 工程師則抗議此舉會造成手機厚度超標、美學垮台，兩方在會議上相持不下。TPM 的天職職責是？", o: ["作為傳話筒，將兩邊吵架的字句如實發出會議記錄，不作評判", "調閱決策代償矩陣（Trade-off Matrix），精算天線效能與外殼肉厚代償方案，主導跨功能技術仲裁逼出黃金折衷點", "直接宣佈會議無限期延長，直到其中一方認輸"], a: 1 },
            { q: "產品在市場發生開箱即損（DOA）故障率超標，客退品應送往何處進行屍檢剖析？", o: ["產品市場行銷與概念調研部", "早期失效分析中繼站（EFFA / DOA Autopsy Line）進行物理開殼分析與缺陷追溯", "直接推回 SMT 熔爐重新過火"], a: 1 },
            { q: "在精密五金 enclosure 外殼試產中，用來量產前評估工廠沖壓流水線對特定公差尺寸的『製程能力指數』是？", o: ["BOM Cost 物料清單硬體總成本", "Cpk 製程能力指數", "PRD 產品需求需求規格書"], a: 1 },
            { q: "在 SMT 製程中，架設在鋼網錫膏印刷機正後方、用來在過爐前及時攔截錫膏印偏 or 厚度不均的 3D 量測關鍵天眼設備是？", o: ["AOI 自動光學檢測儀", "SPI 錫膏檢查儀", "X-Ray 射線斷層掃描儀"], a: 1 },
            { q: "高階相機模組為了排除微米級公差，在點亮動態下利用六軸機器手臂微調至最清晰交點的製程工藝叫？", o: ["ICT 電路針床測試技術", "AA 主動對位技術（Active Alignment）", "表面陽極氧化化學皮層工藝"], a: 1 },
            { q: "防水橡膠圈（O-Ring）在結構鎖附壓合時，為了防範回彈力不足漏水或應力疲勞崩潰，其物理受壓形變率必須剛性維持在多少黃金區間？", o: ["1% ~ 5% 極微形變區間", "25% ~ 40% 黃金壓縮比區間", "90% ~ 100% 徹底擠壓擠扁區間"], a: 1 },
            { q: "各國強制的無線通訊協議與電磁輻射法規認證（如美國 FCC、歐盟 CE），在 NPI 生命周期中屬於哪一範疇的剛性防線？", o: ["EMS Factory 代工製造廠製程範疇", "Compliance 法規法遵界防線認證範疇", "Vendor 零件廠商材料範疇"], a: 1 },
            { q: "在 NPI 生命周期模型中，哪一個試產里程碑的 Exit Criteria（出關基準）是『實現電路原理圖與 PCB Layout 的首版通電打通（Power-on）』？", o: ["EVT 工程驗證測試生命週期", "PVT 生產驗證測試生命週期", "MP 大量量產階段"], a: 0 },
            ...
            { q: "金屬鋁合金外殼表面為了達到防刮、抗氧化且吸附裝飾色彩的目的，在化學池中進行的電化學工藝叫？", o: ["Reflow 迴流焊熔焊工藝", "Anodization（陽極氧化工藝）", "Dispensing 精密自動點膠製程"], a: 1 },
            { q: "BOM Cost 在專案財務審查與 TPM 開發防線中，代表的核心含意是指？", o: ["代工廠流水線開線的試產電費與耗材成本", "物料清冊清單硬體總組裝成本", "技術專案經理的加班費總和"], a: 1 },
            { q: "智慧無人機在 FATP 線體總裝完畢後，為防止升空飛行後發生嚴重的羅盤漂移或炸機災難，必須強制架設哪一個特有測試站工位？", o: ["ICT 主板電路漏電針床站", "IMU 慣性核心動態六面翻轉校正站（Calibration）", "包裝 Packing 秤重防錯防缺料站"], a: 1 },
            ...
            { q: "工廠 FATP 組裝線發生集體螢幕刮傷不良，工廠品保稱是前段進料問題，TPM 該如何快速現場釐清權責邊界？", o: ["直接判定為上游 Vendor 賠償，開單罰款", "調閱 IQC（進料檢驗）原始抽檢數據報告，對比流水線 Assembly 拆解卡具的物理刮擦軌跡，精準判定是進料瑕疵還是線體治具刮傷", "不做任何調查，直接要求設計師修改 PRD 提高刮傷容忍公差"], a: 1 },
...
(function() {
    ...
    window.codexCourseEngineData[0].examVault = vault.slice(0, 20);
})();
