...
========================================================================
2026-05-29 V5.4: 👑 考場硬核升級版：校正時間。全量多行展開。保留 Section 1~3 所有富文本卡牌數據。將考題庫發動史詩級擴充至 30 題實戰情境題。尾部銲死「Fisher-Yates 雙重隨機亂序抽題引擎」，全自動打亂題序、打亂選項並動態修正答案索引，精準抽取 20 題，徹底阻斷死記。
========================================================================
*/
...
codexCourseEngineData = [
    {
                ...
                subMatrixBranches: [
                    ...
                    },
                    {
                        ...
                        diagramFlowArray: [
                            ...
                            { name: "CG/BG 真空防水壓合", highlight: true, text: "<div class='tactical-alert-card'><span class='tactical-badge'>PHONE IP68</span><strong>會做什麼：</strong>高階手機多軸精密自動點膠與真空保壓。<strong>核心目標：</strong>以微米級精度噴塗防水膠路並送入治具密合。<strong>終極期待：</strong>建立 IP68 黃金氣密測試防線，確保信賴性防水測試不發生任何滲水漏氣。</div>" },
                    ...
                    },
                    {
                        ...
                        diagramFlowArray: [
                            ...
                            { name: "IMU 感測器動態校正", highlight: true, text: "<div class='tactical-alert-card'><span class='tactical-badge'>DRONE IMU</span><strong>會做什麼：</strong>專屬三軸旋轉陀螺儀動態治具校正。<strong>核心目標：</strong>對加速度計、指南針進行『動態六面翻轉校正』。<strong>終極期待：</strong>將感測器零偏徹底洗淨歸零，確保凡間飛行絕不發生漂移炸機。</div>" }
                        ],
        ...
        examVault: [
            ...
            { 
                ...
                o: ["客戶的 CMF 貼圖與表面美學樣板說明", "100% 滿載的極限公差疊加分析（Tolerance Stack Analysis）與 DFM 可製造性最終審查", "工廠目前的每小時產速（UPH）預估報告"], 
                a: 1 
            },
            { 
                q: "在 DVT 階段進行整機氣密測試（Leak Test）時，發現金屬框與玻璃接縫處集體爆發漏氣，工廠工程師宣稱是防水膠固化劑調配不均，TPM 該如何利用數據主導技術拆彈？", 
                o: ["全盤聽從工廠說法，要求日本膠水原廠直接退款補償", "發起鎖附扭力對比、外殼微觀間隙量測與膠路寬度微調的 DOE 實驗驗證，以數據斷定是結構應力干涉還是材料失效", "直接向客戶提議將整機防水規格從剛性 IPX8 降為 IPX4 以順利出關"], 
                a: 1 
            },
            { 
            ...
            { 
                q: "產品放水流入實體市場後，用戶集體回報開箱即損（DOA）故障率超標。這批客退品應第一時間強制送往何處進行屍檢剖析？", o: ["產品市場行銷與概念調研部", "早期失效分析中繼站（EFFA / DOA Autopsy Line）進行物理開殼分析與缺陷追溯", "直接推回 SMT 熔爐重新過爐烘烤"], 
                a: 1 
            },
            { 
            ...
            { 
                q: "高階相機模組為了排除微米級組裝公差，在點亮動態下利用六軸機器手臂微調至最清晰交點的製程工藝叫？", 
                o: ["ICT 電路針床測試技術", "AA 主動對位技術（Active Alignment）", "表面陽極氧化化學皮層工藝"], 
                a: 1 
            },
            { 
                q: "防水橡膠圈（O-Ring）在結構鎖附壓合時，為了防範回彈回彈力不足漏水或應力疲勞崩潰，其物理受壓形變率必須剛性維持在多少黃金區間？", 
                o: ["1% ~ 5% 極微形變區間", "25% ~ 40% 黃金壓縮比區間", "90% ~ 100% 徹底擠壓擠扁區間"], 
                a: 1 
            },
            { 
                q: "各國強制的無線通訊協議與電磁輻射法規認證（如美國 FCC、歐盟 CE），在 NPI 生命週期中屬於哪一範疇的剛性防線？", 
            ...
            { 
                q: "在 DVT 階段整機摔落測試（Drop Test）中，產品在特定角度連續跌落時內部結構卡鉤發生集體應力斷裂，TPM 應主導？", 
            ...
            { 
                q: "大流水線 FATP 的外觀品檢站（Cosmetic Inspection），為防範不同班別操作員對刮傷定義不一引發誤判或漏檢，TPM 必須主導線體建立？", 
