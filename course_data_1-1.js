...
安全規格：100% 拒絕任何濃縮裁剪，完整還原全分頁高密度關鍵詞，滿血回歸 270 行大容量。
        ...
        },
        {
          ...
          keywords: [
            ...
            { 
              ...
              meaning: "工廠 IQC 在抽驗原物料時所套用的量測手法、電路硬體治具與軟體測試演算法，必須與生產線後段的實體量產測站（如射頻 RF 測試站、功能功能校正 FCT 測站）保持 100% 剛性同步，徹底封死因兩端測試方法不對位引發的誤判或漏檢盲區。" 
            },
            { 
              name: "AQL 抽樣加嚴", 
